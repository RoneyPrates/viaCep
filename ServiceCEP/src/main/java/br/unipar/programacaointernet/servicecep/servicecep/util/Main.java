...
public class Main {
    ...
    private static void salvarEndereco() {
        try {
            System.out.println("Riviera");
            EnderecoDao enderecoDao = new EnderecoDAOImpl(EntityManagerUtil.getManager());
            enderecoDao.save(getViaCep("85814804"));
            System.out.println(getViaCep("85814804"));
        } catch (Exception e) {
    ...
    private static void salvarUsuario() {
        ...
        usuario.setNome("Lulazinho");
        usuario.setLogin("lulazinho123");
